...
class Album(models.Model):
    ...
    artistID = models.ForeignKey(Artist, on_delete=models.CASCADE) # When you delete an artistID, Album will be deleted too
...
class Track(models.Model):
    ...
    albumID = models.ForeignKey(Album, on_delete=models.CASCADE) # When you delete an Album, the Track will be deleted too
    genreID = models.ForeignKey(Genre, on_delete=models.SET_NULL, null=True) # When you delete a Genre, it'll SET NULL for genre in Track
